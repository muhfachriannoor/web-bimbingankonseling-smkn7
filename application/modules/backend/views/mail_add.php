...
<div id="content">
	<div class="container">
	  	<div class="row">
	    	<div class="col-md-12">
	    		<h4 class="page-title">Tambah Data Mail</h4>
	  		</div>
		</div>
		<div class="content">
			<div class="row">
	    		<div class="col-md-12">
	           		<form method="post" action="<?php echo base_url('backend/mail/input_mail_proses');?>" enctype="multipart/form-data">
	           			<div class="row">
	           				<div class="col-md-4">
	           				...
	           				<div class="col-md-4">
	           					<div class="form-group">
									<label>Nama Wali Kelas</label>
           							<div id="nama_guru">
										<input type="text" name="nama_guru" class="form-control" readonly>
									</div>
								</div>
	           				</div>
	           				<div class="col-md-4">
